...
function CargarMenu() {
    ...
    $.ajax({
        ...
        dataType: "json",
        async: false,
        url: baseUrl+"Servicios/ServicioSistema.asmx/ObtenerModulos",
        ...
        success: function (result) {
            ...
            for (i = 0; i < b.length; i++) {
                ...
                var idmodulo = b[i].NombreModulo.replace(/\s+/g, '');
                ...
                if (b[i].labelInfo > 0) {
                    ...
                    $('#menu').append("<li class=''>" +
                                               ...
                                               icono +
                       "<span data-localize='sidebar.nav." + idmodulo + "'>" + b[i].NombreModulo + "</span>" +
                   "</a> <ul id=" + idmodulo + " class='nav sidebar-subnav collapse'><li class='sidebar-subnav-header'>" + b[i].NombreModulo + "</li></ul></li>");
                }
                else {
                    $('#menu').append("<li class=''>" +
                                               "<a href='#" + idmodulo + "' title='" + b[i].NombreModulo + "' data-toggle='collapse'> " +
                ...
                for (x = 0; x < b[i].opciones.length; x++) {
                    ...
                    var urlopc = ResolveUrl(b[i].opciones[x].UrlRelativaOpcion);
                    //var urlimgopc = b[i].opciones[x].UrlImagen.replace('~', '..');  
                    var nomOpc = b[i].opciones[x].NombreOpcion;

                    $("#" + idmodulo).append("<li class=''><a href='" + urlopc + "' target='_self'>" + "<span>" + nomOpc + "</span></a></li>");
                }
            }
            if (hdIdComprador.value != 0) {
                CargarSistemas(hdIdComprador.value);
...
$(function () {
    ...
    $(".btn.agregar").each(function (index) {
        ...
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-plus'></i></br>Agregar"); }
    ...
    $(".btn.nuevo").each(function (index) {
        $(this).addClass("btn-success");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-file-text'></i></br>Nuevo"); }
    ...
    $(".btn.aceptar").each(function (index) {
        $(this).addClass("btn-success");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-check'></i></br>Aceptar"); }
    ...
    $(".btn.guardar").each(function (index) {
        $(this).addClass("btn-success");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-save'></i></br>Guardar"); }
    ...
    $(".btn.imprimir").each(function (index) {
        ...
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa icon-printer'></i></br>Imprimir"); }
    ...
    $(".btn.descargar").each(function (index) {
        $(this).addClass("btn-info");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-download'></i></br>Descargar"); }
    ...
    $(".btn.detalles").each(function (index) {
        $(this).addClass("btn-info");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-list'></i></br>Detalles"); }
    ...
    $(".btn.editar").each(function (index) {
        ...
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-pencil'></i></br>Editar"); }
    ...
    $(".btn.subir").each(function (index) {
        $(this).addClass("btn-warning");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-upload'></i></br>Subir"); }
    ...
    $(".btn.cancelar").each(function (index) {
        ...
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-ban'></i></br>Cancelar"); }
    ...
    $(".btn.eliminar").each(function (index) {
        $(this).addClass("btn-danger");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-trash'></i></br>Eliminar"); }
    ...
    $(".btn.calendario").each(function (index) {
        ...
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-calendar'></i></br>Calendario"); }
    ...
    $(".btn.regresar").each(function (index) {
        $(this).addClass("btn-default");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-reply'></i></br>Regresar"); }
        if ($(this).hasClass('ti')) { $(this).append("<i class='icon fa fa-reply'></i>Regresar"); }
    });
    ...
    $(".btn.enviar").each(function (index) {
        $(this).addClass("btn-success");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-send'></i></br>Enviar"); }
        if ($(this).hasClass('ti')) { $(this).append("<i class='icon fa fa-send'></i>Enviar"); }
    });
    //Seleccionar
    $(".btn.seleccionar").each(function (index) {
        $(this).addClass("btn-default");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-check-square-o'></i></br>Seleccionar"); }
        if ($(this).hasClass('ti')) { $(this).append("<i class='icon fa fa-check-square-o'></i>Seleccionar"); }
    });
    //Deseleccionar     
    $(".btn.deseleccionar").each(function (index) {
        $(this).addClass("btn-default");
        $(this).attr("data-toggle", "tooltip");
        if ($(this).hasClass('i')) { $(this).addClass("btn-icon"); $(this).append("<i class='icon fa fa-square-o'></i></br>Deseleccionar"); }
        if ($(this).hasClass('ti')) { $(this).append("<i class='icon fa fa-square-o'></i>Deseleccionar"); }
    });
    //Actualizar
    $(".btn.actualizar").each(function (index) {
        ...
        if ($(this).hasClass('ti')) { $(this).append("<i class='icon fa fa-refresh'></i>Actualizar") }
    });
